  ...
  return (
    <>
      ...
      <form action={createTodo} className='flex gap-2 flex-col'>
        <input
          type='text' name='title' title='title' className='border border-slate-300 text-slate-300 px-2 py-1 rounded hover:bg-slate-700 focus-within:bg-slate-700 outline-none'
        />
